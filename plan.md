...
Think Shoopify admin or a simple Google Analytics view.
...
- conversions (percentage, fultuates between 22-5%)
...
- User v-container, v-row, v-col for responsive grid layout
